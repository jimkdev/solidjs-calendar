...
export const CalendarHeader: Component<CalendarProps> = (
  props: CalendarProps
) => {
  const previous = () => {
  ...
  return (
    <div>
      <button type="button" onclick={previous} class="header-btn">
        &lt;
      </button>
      {/* <span>
			</span> */}
      <Show
        ...
        fallback={<span>Month, year</span>}
      >
        <button
          type="button"
          onclick={() => {
            props.setMonthsVisible(true);
          }}
      ...
      <button type="button" onclick={next} class="header-btn">
        &gt;
      </button>
      {/* <span>
			</span> */}
